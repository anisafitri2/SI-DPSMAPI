        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <h4 class="col-auto mr-auto">Data Siswa</h4>
                        @if (Auth::user()->getRoleNames()->first() == 'admin')
                            <a href="{{ route('siswa.create') }}" class="btn btn-primary btn-sm col-auto">Tambah Siswa</a>
                        @endif
                    </div>
                </div>
                <div class="card-body">
...
@push('js')
    ...
    {{ $dataTable->scripts() }}
    <script>
        $('#siswa-table').on('click', '.action', function() {
            let data = $(this).data();
            let id = data.id;
            let jenis = data.type;
            //check if delete use sweetalert swal
            if (jenis == 'delete') {
                Swal.fire({
