        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <h4 class="col-auto mr-auto">Tambah Pelanggaran</h4>
                    ...
                    <form method="POST" action="{{ route('pelanggaran.store') }}">
                        ...
                        <div class="mb-2">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama_pelanggaran"
                                placeholder="Nama Pelanggaran" value="{{ old('nama') }}">
                        ...
                        <div class="mb-2">
                            ...
                            <textarea class="form-control" id="keterangan" name="keterangan" placeholder="Keterangan">{{ old('keterangan') }}</textarea>
                            @error('keterangan')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-2">
                            ...
                            <select class="form-control" id="kategori" name="kategori">
                                ...
                                <option value="Ringan" {{ old('kategori') == 'Ringan' ? 'selected' : '' }}>Ringan
                                </option>
                                <option value="Sedang" {{ old('kategori') == 'Sedang' ? 'selected' : '' }}>Sedang
                                </option>
                                <option value="Berat" {{ old('kategori') == 'Berat' ? 'selected' : '' }}>Berat
                                </option>
                            </select>
                            @error('kategori')
                                <div class="text-danger">{{ $message }}</div>
